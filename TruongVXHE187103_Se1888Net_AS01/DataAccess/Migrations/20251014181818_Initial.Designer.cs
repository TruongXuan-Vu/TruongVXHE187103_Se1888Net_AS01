...
namespace DataAccess.Migrations
{
    ...
    [Migration("20251014181818_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Presentation.Models.NewsArticle", b =>
                {
                    b.Property<string>("NewsArticleId")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)")
            ...
            modelBuilder.Entity("Presentation.Models.SystemAccount", b =>
                {
            ...
            modelBuilder.Entity("Presentation.Models.Tag", b =>
                {
                    b.Property<int>("TagId")
                        .HasColumnType("int")
                        .HasColumnName("TagID");
            ...
            modelBuilder.Entity("NewsTag", b =>
                {
                    b.HasOne("Presentation.Models.NewsArticle", null)
                        .WithMany()
                        .HasForeignKey("NewsArticleId")
                        .IsRequired()
                        .HasConstraintName("FK_NewsTag_NewsArticle");

                    b.HasOne("Presentation.Models.Tag", null)
                        .WithMany()
                        .HasForeignKey("TagId")
                        .IsRequired()
            ...
            modelBuilder.Entity("Presentation.Models.NewsArticle", b =>
                {
                    ...
                    b.HasOne("Presentation.Models.SystemAccount", "CreatedBy")
                        .WithMany("NewsArticles")
